...
public class Sessions  implements java.io.Serializable {
   ...
   public Sessions(String sid, Short ip1, Short ip2, Short ip3, Short ip4, Integer uid, String username, Short groupid, Short styleid, Byte invisible, Short action, Integer lastactivity, Integer lastolupdate, Short pageviews, Integer seccode, Short fid, Integer tid, Integer bloguid) {
       this.sid = sid;
       this.ip1 = ip1;
       this.ip2 = ip2;
       this.ip3 = ip3;
