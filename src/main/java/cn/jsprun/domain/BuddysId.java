...
public class BuddysId  implements java.io.Serializable {
    ...
    public BuddysId(Integer uid, Integer buddyid, Short grade, Integer dateline, String description) {
        this.uid = uid;
 ...
 && ( (this.getGrade()==castOther.getGrade()) || ( this.getGrade()!=null && castOther.getGrade()!=null && this.getGrade().equals(castOther.getGrade()) ) )
