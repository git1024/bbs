...
public class Members  implements java.io.Serializable {
    ...
    public Byte getXspacestatus() {
        return this.xspacestatus;
    }
    
    public void setXspacestatus(Byte xspacestatus) {
        this.xspacestatus = xspacestatus;
    }
