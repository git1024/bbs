...
public class SessionsId  implements java.io.Serializable {
    ...
    public SessionsId(String sid, Short ip1, Short ip2, Short ip3, Short ip4, Integer uid, String username, Short groupid, Short styleid, Byte invisible, Short action, Integer lastactivity, Integer lastolupdate, Short pageviews, Integer seccode, Short fid, Integer tid, Integer bloguid) {
        this.sid = sid;
        this.ip1 = ip1;
        this.ip2 = ip2;
        this.ip3 = ip3;
    ...
    public Integer getBloguid() {
        return this.bloguid;
    }
    
    public void setBloguid(Integer bloguid) {
        this.bloguid = bloguid;
    }
 ...
 && ( (this.getBloguid()==castOther.getBloguid()) || ( this.getBloguid()!=null && castOther.getBloguid()!=null && this.getBloguid().equals(castOther.getBloguid()) ) );
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getBloguid() == null ? 0 : this.getBloguid().hashCode() );
         return result;
   }   
