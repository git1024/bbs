...
public class Forumfields  implements java.io.Serializable {
    ...
    public Forumfields(Short fid, String description, String password, String icon, String postcredits, String replycredits, String getattachcredits, String postattachcredits, String digestcredits, String redirect, String attachextensions, String formulaperm, String moderators, String rules, String threadtypes, String viewperm, String postperm, String replyperm, String getattachperm, String postattachperm, String keywords, String supe_pushsetting, String modrecommend, String tradetypes, String typemodels) {
        this.fid = fid;
        ...
        this.supe_pushsetting = supe_pushsetting;
    ...
    public void setSupe_pushsetting(String supePushsetting) {
        this.supe_pushsetting = supePushsetting;
    }
