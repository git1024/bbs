...
public class Admingroups  implements java.io.Serializable {
	...
	private Short admingid;			
     ...
     private Byte supeAllowpushthread;	
    ...
    public Byte getSupeAllowpushthread() {
        return this.supeAllowpushthread;
    }
    
    public void setSupeAllowpushthread(Byte supeAllowpushthread) {
        this.supeAllowpushthread = supeAllowpushthread;
    }
