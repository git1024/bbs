		...
		<table summary="trade_displayorder" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<c:choose>
					...
					<c:otherwise>
					<a href="viewthread.jsp?do=tradeinfo&tid=${threads.tid}&pid=${trade.pid}" target="_blank"><img class="absmiddle" src="images/default/trade_nophotosmall.gif" onload="thumbImg(this)" width="48" height="48" alt="${trade.subject}" /></a>
					</c:otherwise>
				</c:choose>
				</td>
				<td>
