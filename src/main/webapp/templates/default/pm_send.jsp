...
<form method="post" id="postform" action="pm.jsp?action=send&submit=yes" onSubmit="return validate(this)">
	...
	<div class="mainbox formbox">
		...
		<table summary="<bean:message key="pm_send"/>" cellspacing="0" cellpadding="0" id="pmlist">
			...
			<tr class="btns"><th>&nbsp;</th><td><button type="submit" class="submit" name="pmssubmit" value="true" tabindex="7"><bean:message key="submitf"/></button> <em><bean:message key="post_submit_hotkey"/></em> &nbsp;<a href="###" id="restoredata" onclick="loadData()" title="<bean:message key="post_autosave_last_restore"/>"><bean:message key="post_autosave_restore"/></a></td></tr>
		</table>
	</div>
</form>
