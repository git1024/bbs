...
<meta name="copyright" content="2007-2010 JspRun Inc." />
...
<c:if test="${!empty requestPath}"><meta http-equiv="refresh" content="${refreshtime} url=${requestPath}"></c:if>
...
<script type="text/javascript">
if(top == self) {
if(${settings.frameon==2&&(requestScope.frameon!='no'&&sessionScope.frameon=='yes'||requestScope.frameon==null&&sessionScope.frameon==null)}){
